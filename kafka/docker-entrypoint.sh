...
: ${KAFKA_LISTENERS:=CLIENT://$KAFKA_HOST_NAME:$KAFKA_PORT,EXTERNAL://:9093}
: ${KAFKA_ADVERTISED_LISTENERS:=CLIENT://$KAFKA_ADVERTISED_HOST_NAME:$KAFKA_ADVERTISED_PORT,EXTERNAL://localhost:9093}
: ${KAFKA_LISTENER_SECURITY_PROTOCOL_MAP:=CLIENT:PLAINTEXT,EXTERNAL:PLAINTEXT}
: ${KAFKA_INTER_BROKER_LISTENER_NAME:=CLIENT}

export KAFKA_LISTENERS KAFKA_ADVERTISED_LISTENERS KAFKA_INTER_BROKER_LISTENER_NAME KAFKA_LISTENER_SECURITY_PROTOCOL_MAP ALLOW_PLAINTEXT_LISTENER
